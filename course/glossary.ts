...
export const glossary: GlossaryTerm[] = [
  ...
  { id: "agent-loop", term: "Agent loop", definition: "Цикл цель → модель → tool → observation → состояние → следующий шаг до стопа.", weekSlug: "agent-loop", related: ["workflow"] },
  { id: "workflow", term: "Workflow", definition: "Заранее описанный граф шагов. Может содержать LLM-шаг, но ветки ваши.", weekSlug: "automation-fundamentals", related: ["agent-loop"] },
  ...
  { id: "pgvector", term: "pgvector", definition: "Расширение PostgreSQL для векторов. Сначала оно, отдельная vector DB по факту масштаба.", weekSlug: "pgvector", related: ["embedding"] },
