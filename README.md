...
- Module 1 (недели 1-4), Module 2 (недели 5-6), Module 3 (недели 7-10) и Module 4 (недели 11-12) написаны полностью
- Недели 13-32 и capstone имеют обзор, уроки, лабу, практику, промпт, квиз и артефакт. Теория будет углубляться по модулям
