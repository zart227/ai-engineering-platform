...
- Module 1 (недели 1-4) и Module 2 (недели 5-6) написаны полностью
- Недели 7-32 и capstone имеют обзор, уроки, лабу, практику, промпт, квиз и артефакт. Теория будет углубляться по модулям
