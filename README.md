...
- Module 1 (недели 1-4), Module 2 (недели 5-6), Module 3 (недели 7-10), Module 4 (недели 11-12), Module 5 (недели 13-16) и Module 6 (неделя 17) написаны полностью
- Недели 18-32 и capstone имеют обзор, уроки, лабу, практику, промпт, квиз и артефакт. Теория будет углубляться по модулям
