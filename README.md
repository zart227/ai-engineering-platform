...
- Модули 1-18 написаны полностью: 32 учебные недели и отдельный Capstone (slug `capstone`)
...
Источник истины: PostgreSQL. Черновики textarea коротко живут в `localStorage` ключом `aep-draft:*`, пока сервер не подтвердил «Сохранено».
