...
- Module 1 (недели 1-4), Module 2 (недели 5-6), Module 3 (недели 7-10), Module 4 (недели 11-12), Module 5 (недели 13-16), Module 6 (неделя 17), Module 7 (неделя 18), Module 8 (неделя 19), Module 9 (недели 20-21) и Module 10 (неделя 22) написаны полностью
- Недели 23-32 и capstone имеют обзор, уроки, лабу, практику, промпт, квиз и артефакт. Теория будет углубляться по модулям
