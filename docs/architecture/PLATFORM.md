...
11. Недели 23-32 и capstone: карта + проходимые обзор/лаба/практика/квиз/артефакт
12. Дальше углубление теории по модулям, не массовая вода
...
| Объём контента vs качество | педагогический | Module 1 глубокий; остальные недели честно outlined/ready |
