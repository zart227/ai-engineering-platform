...
- Глоссарий не менялся. Запросы агентов на новые термины не применены.
- CR1–CR5 закрыты в этом проходе. См. раздел ниже.

## Wave 3 — ревью

CR1 progression: PASS. Указатели недель поправлены в 20, 25, 29, 31.
CR2 duplication: PASS. Недели 5/6 и 13/14 близки по формулировке, практика разная. Не склеивал.
CR3 prerequisites: PASS. Те же указатели.
CR4 depth: PASS. Сравнение одного агента и нескольких есть на неделе 20. На недели 19, 21, 22 и 23 тот же шаг не копировался: там SDK, исследование, план и HITL.
CR5 portfolio: MAJOR на capstone. В шаг «Объём» и чеклист `cap-a7` добавлена таблица: slug недели, артефакт, берёте или не-цель, причина.
Длинное тире убрано из недели 4.
Глоссарий: agent-budget, recall-at-k, tool-shadowing, at-most-once, at-least-once, exactly-once, pii, percentile. Связи только на существующие id.

## Gate 3

PASS после тестов этого прохода. Массовая миграция недель закончена. Wave 4 может встраивать недостающие темы в уже существующие файлы, без недель 34+.

## Wave 4

M1 `473894d` неделя 2, шаг «Один prompt, API и local».
M2 `dee5077` неделя 32, шаг «Один запрос, пять подряд, таймаут».
M3 `907f7c8` неделя 25, шаг «Таблица рычагов». Обучения весов нет.
M4 `4842375` неделя 10, шаг «Маршрут модели».
M5 неделя 24 уже различает reliability, security, safety, privacy. Файл не менялся.
